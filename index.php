          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">Ctedarikçi'den 'XXX' koli sipariş depoya ulaştı. </span>
                    <!-- Emphasis label -->
                  ...
                  <li>
                    ...
                    <span class="text">Atedarikçi'den 'XXX' koli 'YYY' ürün sipariş edildi.</span>
              ...
              <div class="card-footer clearfix">
                <button type="button" class="btn btn-primary float-right" id="addItemButton">
                  <i class="fas fa-plus">Yeni öğe ekle</i> 
              </button>
            </div>
            <div class="card-body">
              <ul class="todo-list" data-widget="todo-list" id="itemList">
                  <!-- Liste öğeleri burada eklenecek -->
              </ul>
          </div>  
            <!-- /.card -->
          </section>
...
<script src="../kds/main.js"></script>
<script src="../kds/app.js"></script>
